...
public interface IQAConnectionOptimizationService
{
...
public class QAConnectionOptimizationService : IQAConnectionOptimizationService
{
    private readonly IHubContext<QAHub> _hubContext;
    private readonly ILogger<QAConnectionOptimizationService> _logger;
    private readonly QAConnectionOptions _options;
    ...
    public QAConnectionOptimizationService(
        IHubContext<QAHub> hubContext,
        ILogger<QAConnectionOptimizationService> logger,
        IOptions<QAConnectionOptions> options)
    {
...
public class QAConnectionOptions
{
    public const string SectionName = "QAConnection";
