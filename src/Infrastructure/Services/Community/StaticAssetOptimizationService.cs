...
public class StaticAssetOptimizationService : IStaticAssetOptimizationService
{
    ...
    private readonly StaticAssetOptions _options;
    ...
    public StaticAssetOptimizationService(
        HttpClient httpClient,
        ILogger<StaticAssetOptimizationService> logger,
    ...
    private List<CriticalSharedAsset> GetCriticalSharedAssets()
    {
        return new List<CriticalSharedAsset>
        {
            ...
            new() { Path = "/css/shared.css", Type = SharedAssetType.Styles, Priority = 1 },
            new() { Path = "/css/components.css", Type = SharedAssetType.Styles, Priority = 1 },
            
            // Shared QA scripts
            new() { Path = "/js/shared.js", Type = SharedAssetType.Scripts, Priority = 1 },
            new() { Path = "/js/signalr.min.js", Type = SharedAssetType.Scripts, Priority = 1 },
            
            // Shared icons and fonts
            new() { Path = "/icons/icons.svg", Type = SharedAssetType.Icons, Priority = 2 },
            new() { Path = "/fonts/font.woff2", Type = SharedAssetType.Fonts, Priority = 2 },
            
            // Framework-specific but shared assets
            new() { Path = "/css/responsive.css", Type = SharedAssetType.Styles, Priority = 3 },
            new() { Path = "/js/utils.js", Type = SharedAssetType.Scripts, Priority = 3 }
        };
    }
    ...
    private OptimizationLevel DetermineOptimizationLevel(SharedAssetType assetType)
    {
        ...
        {
            SharedAssetType.Styles => OptimizationLevel.High,
            SharedAssetType.Scripts => OptimizationLevel.High,
            SharedAssetType.Icons => OptimizationLevel.Medium,
            SharedAssetType.Fonts => OptimizationLevel.Medium,
...
{
    public const string SectionName = "StaticAsset";
