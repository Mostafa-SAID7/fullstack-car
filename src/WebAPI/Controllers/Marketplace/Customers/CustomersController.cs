...
namespace WebAPI.Controllers.Marketplace.Customers;

[Authorize(Roles = "Admin")]
[ApiVersion("3.0")]
[Route("api/v{version:apiVersion}/marketplace/customers")]
public class CustomersController : BaseController
{
    ...
    [HttpPatch("{id}/status")]
    public async Task<IActionResult> UpdateCustomerStatus(Guid id, [FromBody] Domain.Enums.Marketplace.CustomerStatus status)
    {
        try
        {
    ...
    [HttpPatch("{id}/type")]
    public async Task<IActionResult> UpdateCustomerType(Guid id, [FromBody] Domain.Enums.Marketplace.CustomerType type)
    {
        try
        {
