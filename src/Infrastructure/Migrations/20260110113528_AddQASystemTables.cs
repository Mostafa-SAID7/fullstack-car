...
{
    /// <inheritdoc />
    public partial class AddQASystemTables : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), 18.5m, 12, 74.2m, new DateTime(2025, 12, 31, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(2890), null, null, null, 3, false, new DateTime(2026, 1, 10, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(2235), 89, new Guid("55555555-5555-5555-5555-555555555555"), 1, 15, "[\"US\", \"UK\", \"CA\", \"AU\", \"DE\"]", "[\"Desktop\", \"Mobile\", \"Tablet\"]", "[\"Google\", \"YouTube\", \"Direct\", \"Twitter\"]", null, null, 1250, 45, 1250, 320 },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 28.3m, 23, 80.9m, new DateTime(2026, 1, 5, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(2979), null, null, null, 8, false, new DateTime(2026, 1, 10, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(2977), 156, new Guid("66666666-6666-6666-6666-666666666666"), 1, 31, "[\"US\", \"IN\", \"UK\", \"CA\", \"BR\"]", "[\"Mobile\", \"Desktop\", \"Tablet\"]", "[\"Google\", \"Direct\", \"LinkedIn\", \"Reddit\"]", null, null, 2100, 78, 2100, 540 },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), 35.2m, 8, 78.2m, new DateTime(2026, 1, 2, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(3011), null, null, null, 2, false, new DateTime(2026, 1, 10, 11, 35, 20, 101, DateTimeKind.Utc).AddTicks(2997), 67, new Guid("88888888-8888-8888-8888-888888888888"), 2, 12, "[\"US\", \"UK\", \"CA\", \"AU\", \"NL\"]", "[\"Mobile\", \"Desktop\", \"Smart Speaker\"]", "[\"Spotify\", \"Apple Podcasts\", \"Google Podcasts\", \"Direct\"]", null, null, 850, 25, 850, 180 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "Technology", "https://example.com/images/tech-talk-cover.jpg", new DateTime(2025, 12, 11, 11, 35, 20, 94, DateTimeKind.Utc).AddTicks(751), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Weekly discussions about the latest in technology and software development", true, false, "en", "Tech Talk Weekly", null, null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Business", "https://example.com/images/business-insights-cover.jpg", new DateTime(2025, 12, 16, 11, 35, 20, 94, DateTimeKind.Utc).AddTicks(2259), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Insights and strategies for modern business leaders", true, false, "en", "Business Insights", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("55555555-5555-5555-5555-555555555555"), true, new DateTime(2025, 12, 29, 11, 35, 20, 96, DateTimeKind.Utc).AddTicks(2), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Learn the basics of ASP.NET Core 9 and its new features", 3, new TimeSpan(0, 0, 25, 0, 0), 524288000L, false, true, 89, "https://example.com/videos/aspnet-core-preview.mp4", new DateTime(2025, 12, 31, 11, 35, 20, 95, DateTimeKind.Utc).AddTicks(8039), 1080, 2, "ASP.NET,C#,Web Development,Tutorial", "https://example.com/images/aspnet-core-thumb.jpg", "Introduction to ASP.NET Core 9", null, null, "https://example.com/videos/aspnet-core-intro.mp4", 1250 },
                    { new Guid("66666666-6666-6666-6666-666666666666"), true, new DateTime(2026, 1, 3, 11, 35, 20, 96, DateTimeKind.Utc).AddTicks(83), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Modern React development patterns and best practices", 8, new TimeSpan(0, 0, 35, 0, 0), 734003200L, false, true, 156, null, new DateTime(2026, 1, 5, 11, 35, 20, 96, DateTimeKind.Utc).AddTicks(77), 1080, 2, "React,JavaScript,Frontend,Best Practices", "https://example.com/images/react-best-practices-thumb.jpg", "React Best Practices 2024", null, null, "https://example.com/videos/react-best-practices.mp4", 2100 },
                    { new Guid("77777777-7777-7777-7777-777777777777"), true, new DateTime(2026, 1, 8, 11, 35, 20, 96, DateTimeKind.Utc).AddTicks(106), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Understanding database design principles and normalization", 0, new TimeSpan(0, 0, 42, 0, 0), 419430400L, false, false, 0, null, null, 720, 0, "Database,SQL,Design,Normalization", "https://example.com/images/database-design-thumb.jpg", "Database Design Fundamentals", null, null, "https://example.com/videos/database-design.mp4", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("88888888-8888-8888-8888-888888888888"), true, true, "https://example.com/audio/ai-software-dev.mp3", "https://example.com/images/ai-software-cover.jpg", new DateTime(2025, 12, 31, 11, 35, 20, 99, DateTimeKind.Utc).AddTicks(1604), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Exploring how artificial intelligence is transforming the way we write code", 23, new TimeSpan(0, 0, 45, 0, 0), 15, 43200000L, false, true, 67, 850, new DateTime(2026, 1, 2, 11, 35, 20, 98, DateTimeKind.Utc).AddTicks(688), 2, new Guid("11111111-1111-1111-1111-111111111111"), 2, "AI,Software Development,Machine Learning,Future", "The Future of AI in Software Development", "Welcome to Tech Talk Weekly. Today we're discussing the future of AI in software development...", null, null },
                    { new Guid("99999999-9999-9999-9999-999999999999"), true, true, "https://example.com/audio/scalable-teams.mp3", "https://example.com/images/scalable-teams-cover.jpg", new DateTime(2026, 1, 2, 11, 35, 20, 99, DateTimeKind.Utc).AddTicks(1817), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Strategies for building and managing high-performing development teams", 45, new TimeSpan(0, 0, 38, 0, 0), 8, 36700000L, false, true, 94, 1200, new DateTime(2026, 1, 4, 11, 35, 20, 99, DateTimeKind.Utc).AddTicks(1797), 1, new Guid("33333333-3333-3333-3333-333333333333"), 2, "Team Management,Leadership,Scaling,Business", "Building Scalable Teams", "In today's episode of Business Insights, we explore strategies for building scalable teams...", null, null }
                });
