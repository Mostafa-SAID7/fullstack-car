...
import { QuestionList, QuestionFilter, PaginatedResponse } from '../../../../../shared/types/qa-api.types';
...
export class QuestionListComponent implements OnInit, OnDestroy {
  ...
  // Sort options
  sortOptions = [
    { value: 'createdAt', label: 'Newest First', icon: 'schedule' },
    { value: 'voteScore', label: 'Most Voted', icon: 'thumb_up' },
    { value: 'answerCount', label: 'Most Answered', icon: 'question_answer' },
    { value: 'viewCount', label: 'Most Viewed', icon: 'visibility' },
    { value: 'lastActivityAt', label: 'Recent Activity', icon: 'update' }
  ];
  ...
  filterTabs = [
    ...
    { value: 'answered', label: 'Answered', icon: 'check_circle_outline' },
    { value: 'closed', label: 'Closed', icon: 'lock_outline' }
  ];
