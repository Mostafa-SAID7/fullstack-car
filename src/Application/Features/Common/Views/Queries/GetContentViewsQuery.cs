...
public record GetContentViewsQuery(
    Guid ContentId,
    ContentType ContentType,
    int Page = 1,
    int PageSize = 10
) : IRequest<Result<PaginatedList<ViewResponse>>>;

public class GetContentViewsQueryHandler : IRequestHandler<GetContentViewsQuery, Result<PaginatedList<ViewResponse>>>
{
    private readonly IApplicationDbContext _context;

    public GetContentViewsQueryHandler(IApplicationDbContext context)
    {
        _context = context;
    }
