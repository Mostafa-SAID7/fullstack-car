...
namespace Application.Features.Community.Reviews.Commands
{
    ...
    public class VerifyReviewCommandHandler : IRequestHandler<VerifyReviewCommand, Result<bool>>
    {
        ...
        public VerifyReviewCommandHandler(IRepository<Review> reviewRepository, IUnitOfWork unitOfWork)
        {
            _reviewRepository = reviewRepository;
            _unitOfWork = unitOfWork;
        }

        public async Task<Result<bool>> Handle(VerifyReviewCommand command, CancellationToken cancellationToken)
        {
