...
public class GroupMemberRepository : Repository<GroupMember>, IGroupMemberRepository
{
    ...
    public async Task<IEnumerable<GroupMember>> GetGroupModeratorsAsync(Guid groupId, CancellationToken cancellationToken = default)
    {
        return await _context.Set<GroupMember>()
            .Include(m => m.User)
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return new PaginatedResult<GroupMember>(items, totalCount, pageNumber, pageSize);
    }
