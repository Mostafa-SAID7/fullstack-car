...
public interface IQACdnOptimizationService
{
...
public class QACdnOptimizationService : IQACdnOptimizationService
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<QACdnOptimizationService> _logger;
    private readonly QACdnOptions _options;
    ...
    public QACdnOptimizationService(
        HttpClient httpClient,
        ILogger<QACdnOptimizationService> logger,
        IOptions<QACdnOptions> options)
    {
    ...
    private List<CriticalAsset> GetCriticalAssets()
    {
        ...
        {
            new() { Path = "/css/qa-styles.css", Type = AssetType.Css, Priority = 1 },
            new() { Path = "/js/qa-main.js", Type = AssetType.JavaScript, Priority = 1 },
            new() { Path = "/js/signalr.min.js", Type = AssetType.JavaScript, Priority = 1 },
            new() { Path = "/images/qa-icons.svg", Type = AssetType.Image, Priority = 2 },
            new() { Path = "/fonts/qa-font.woff2", Type = AssetType.Font, Priority = 2 },
            new() { Path = "/css/qa-responsive.css", Type = AssetType.Css, Priority = 3 },
            new() { Path = "/js/qa-search.js", Type = AssetType.JavaScript, Priority = 3 }
        };
    }
    ...
    private async Task TriggerCdnPreloadAsync(string url, CancellationToken cancellationToken)
    {
        try
        {
            ...
            request.Headers.Add("User-Agent", "QA-CDN-Preloader/1.0");
...
public class QACdnOptions
{
    public const string SectionName = "QACdn";
