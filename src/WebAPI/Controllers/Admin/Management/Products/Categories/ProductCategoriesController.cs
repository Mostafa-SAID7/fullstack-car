...
namespace WebAPI.Controllers.Admin.Management.Products.Categories;

[Authorize(Roles = "Admin")]
[ApiVersion("3.0")]
[Route("api/v{version:apiVersion}/admin/products/categories")]
public class ProductCategoriesController : BaseController
{
    ...
    public async Task<IActionResult> GetProductsByCategory(
        Domain.Enums.Admin.Management.ProductCategory category,
