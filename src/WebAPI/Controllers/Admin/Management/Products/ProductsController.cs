...
namespace WebAPI.Controllers.Admin.Management.Products;
...
public class ProductsController : BaseController
{
    ...
    public async Task<IActionResult> GetAllProducts(
        ...
        [FromQuery] Domain.Enums.Admin.Management.ProductStatus? status = null,
        [FromQuery] Domain.Enums.Admin.Management.ProductCategory? category = null,
    ...
    [HttpPatch("{id}/status")]
    public async Task<IActionResult> UpdateProductStatus(Guid id, [FromBody] Domain.Enums.Admin.Management.ProductStatus status)
    {
        try
        {
