...
namespace Application.Features.Admin.Management.Products.Commands;
...
public class UpdateProductStatusCommand : IRequest<Result<bool>>
{
    public Guid ProductId { get; set; }
    public Guid AdminId { get; set; }
    public Domain.Enums.Admin.Management.ProductStatus Status { get; set; }
}
...
public class BulkUpdateProductsCommand : IRequest<Result<int>>
{
    ...
    public Guid AdminId { get; set; }
    public Domain.Enums.Admin.Management.ProductStatus? Status { get; set; }
    public Domain.Enums.Admin.Management.ProductCategory? Category { get; set; }
