...
/// <summary>
/// QA System Health Status DTO
/// Provides comprehensive health information following existing monitoring patterns
/// </summary>
public class QASystemHealthDto
{
    public string Status { get; set; } = string.Empty; // "Healthy", "Warning", "Critical"
    public DateTime Timestamp { get; set; }
    public long CheckDurationMs { get; set; }
    public string? Error { get; set; }
    public QAHealthMetricsDto? Metrics { get; set; }
    public QADependencyHealthDto? Dependencies { get; set; }
}

/// <summary>
/// QA Health Metrics DTO
/// Contains key performance indicators for QA system health
/// </summary>
public class QAHealthMetricsDto
{
...
/// <summary>
/// QA Dependency Health DTO
/// Tracks health of external dependencies
/// </summary>
public class QADependencyHealthDto
{
...
/// <summary>
/// QA Performance Metrics DTO
/// Detailed performance analytics for dashboard display
/// </summary>
public class QAPerformanceMetricsDto
{
    public DateTime Timestamp { get; set; }
    public List<QAMetricDataPointDto> QuestionTrends { get; set; } = new();
    public List<QAMetricDataPointDto> AnswerTrends { get; set; } = new();
    public List<QAMetricDataPointDto> VoteTrends { get; set; } = new();
    public double ExpertResponseRate { get; set; }
    public QASearchPerformanceDto SearchPerformance { get; set; } = new();
    public QASystemLoadDto SystemLoad { get; set; } = new();
}

/// <summary>
/// QA Metric Data Point DTO
/// Individual data point for trend charts
/// </summary>
public class QAMetricDataPointDto
{
...
/// <summary>
/// QA Search Performance DTO
/// Search system performance metrics
/// </summary>
public class QASearchPerformanceDto
{
...
/// <summary>
/// QA User Satisfaction DTO
/// User satisfaction metrics based on engagement and feedback
/// </summary>
public class QAUserSatisfactionDto
{
    public DateTime Timestamp { get; set; }
    ...
    public List<QAMetricDataPointDto> SatisfactionTrend { get; set; } = new();
    public QAFeedbackSummaryDto? FeedbackSummary { get; set; }
}

/// <summary>
/// QA Feedback Summary DTO
/// Summary of user feedback and satisfaction surveys
/// </summary>
public class QAFeedbackSummaryDto
{
...
/// <summary>
/// QA Health Dashboard DTO
/// Complete dashboard data combining all health metrics
/// </summary>
public class QAHealthDashboardDto
{
    public QASystemHealthDto SystemHealth { get; set; } = new();
    public QAPerformanceMetricsDto PerformanceMetrics { get; set; } = new();
    public List<QASystemAlertDto> ActiveAlerts { get; set; } = new();
    public QAUserSatisfactionDto UserSatisfaction { get; set; } = new();
    public QAExpertHealthDto ExpertHealth { get; set; } = new();
    public DateTime LastUpdated { get; set; }
    public string OverallStatus { get; set; } = string.Empty;
}

/// <summary>
/// QA Expert Health DTO
/// Health metrics specific to expert system
/// </summary>
public class QAExpertHealthDto
{
    ...
    public List<QAExpertCategoryHealthDto> CategoryHealth { get; set; } = new();
    public List<QAMetricDataPointDto> ExpertActivityTrend { get; set; } = new();
}

/// <summary>
/// QA Expert Category Health DTO
/// Expert health metrics by category
/// </summary>
public class QAExpertCategoryHealthDto
{
...
/// <summary>
/// QA Performance Alert Configuration DTO
/// Configuration for performance alerts and thresholds
/// </summary>
public class QAPerformanceAlertConfigDto
{
