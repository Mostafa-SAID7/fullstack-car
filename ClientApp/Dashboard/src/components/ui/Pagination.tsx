...
export const Pagination: React.FC<PaginationProps> = ({
  ...
  // Don't show pagination if there are less than 20 items total
  if (totalItems < 20) {
    return null;
  }
  ...
  return (
    <div className={cn("flex flex-col sm:flex-row items-center justify-between gap-4 p-4 bg-card border border-border rounded-lg", className)}>
