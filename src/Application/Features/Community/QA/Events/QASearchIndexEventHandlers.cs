...
/// <summary>
/// Event handlers for automatically updating search index when QA content changes
/// </summary>
public class QASearchIndexEventHandlers :
    ...
    INotificationHandler<VoteDeletedEvent>
{
    ...
    private readonly ILogger<QASearchIndexEventHandlers> _logger;

    public QASearchIndexEventHandlers(
        IQASearchService searchService,
        ILogger<QASearchIndexEventHandlers> logger)
    {
