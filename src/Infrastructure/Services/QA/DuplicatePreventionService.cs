...
public class DuplicatePreventionService : IDuplicatePreventionService
{
    ...
    // Cache keys
    private const string DUPLICATE_CACHE_PREFIX = "qa_duplicate_";
    private const string SIMILARITY_CACHE_PREFIX = "qa_similarity_";
    private const string ANALYTICS_CACHE_KEY = "qa_duplicate_analytics";
