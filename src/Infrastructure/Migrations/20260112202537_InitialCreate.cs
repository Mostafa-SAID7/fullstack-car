        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsRTLPreferred = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalKeys = table.Column<int>(type: "int", nullable: false),
                    TranslatedKeys = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TranslationCompleteness", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Category = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RelatedContentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    RelatedContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Metadata = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QAUserFeedback", x => x.Id);
                    table.ForeignKey(
                        name: "FK_QAUserFeedback_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Culture = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    Feature = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    TranslationKey = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TranslationAudits_AspNetUsers_UpdatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QATags_QACategories_CategoryId",
                        column: x => x.CategoryId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Version = table.Column<int>(type: "int", nullable: false),
                    EditReason = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false, defaultValue: ""),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AnswerHistories_AspNetUsers_EditedByUserId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), 18.5m, 12, 74.2m, new DateTime(2026, 1, 2, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(4361), null, null, null, 3, false, new DateTime(2026, 1, 12, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(3549), 89, new Guid("55555555-5555-5555-5555-555555555555"), 1, 15, "[\"US\", \"UK\", \"CA\", \"AU\", \"DE\"]", "[\"Desktop\", \"Mobile\", \"Tablet\"]", "[\"Google\", \"YouTube\", \"Direct\", \"Twitter\"]", null, null, 1250, 45, 1250, 320 },
                    { new Guid("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), 28.3m, 23, 80.9m, new DateTime(2026, 1, 7, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(4488), null, null, null, 8, false, new DateTime(2026, 1, 12, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(4487), 156, new Guid("66666666-6666-6666-6666-666666666666"), 1, 31, "[\"US\", \"IN\", \"UK\", \"CA\", \"BR\"]", "[\"Mobile\", \"Desktop\", \"Tablet\"]", "[\"Google\", \"Direct\", \"LinkedIn\", \"Reddit\"]", null, null, 2100, 78, 2100, 540 },
                    { new Guid("cccccccc-cccc-cccc-cccc-cccccccccccc"), 35.2m, 8, 78.2m, new DateTime(2026, 1, 4, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(4528), null, null, null, 2, false, new DateTime(2026, 1, 12, 20, 25, 26, 363, DateTimeKind.Utc).AddTicks(4507), 67, new Guid("88888888-8888-8888-8888-888888888888"), 2, 12, "[\"US\", \"UK\", \"CA\", \"AU\", \"NL\"]", "[\"Mobile\", \"Desktop\", \"Smart Speaker\"]", "[\"Spotify\", \"Apple Podcasts\", \"Google Podcasts\", \"Direct\"]", null, null, 850, 25, 850, 180 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-1111-1111-1111-111111111111"), "Technology", "https://example.com/images/tech-talk-cover.jpg", new DateTime(2025, 12, 13, 20, 25, 26, 347, DateTimeKind.Utc).AddTicks(4667), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Weekly discussions about the latest in technology and software development", true, false, "en", "Tech Talk Weekly", null, null },
                    { new Guid("33333333-3333-3333-3333-333333333333"), "Business", "https://example.com/images/business-insights-cover.jpg", new DateTime(2025, 12, 18, 20, 25, 26, 347, DateTimeKind.Utc).AddTicks(7362), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Insights and strategies for modern business leaders", true, false, "en", "Business Insights", null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("55555555-5555-5555-5555-555555555555"), true, new DateTime(2025, 12, 31, 20, 25, 26, 357, DateTimeKind.Utc).AddTicks(999), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Learn the basics of ASP.NET Core 9 and its new features", 3, new TimeSpan(0, 0, 25, 0, 0), 524288000L, false, true, 89, "https://example.com/videos/aspnet-core-preview.mp4", new DateTime(2026, 1, 2, 20, 25, 26, 356, DateTimeKind.Utc).AddTicks(7016), 1080, 2, "ASP.NET,C#,Web Development,Tutorial", "https://example.com/images/aspnet-core-thumb.jpg", "Introduction to ASP.NET Core 9", null, null, "https://example.com/videos/aspnet-core-intro.mp4", 1250 },
                    { new Guid("66666666-6666-6666-6666-666666666666"), true, new DateTime(2026, 1, 5, 20, 25, 26, 357, DateTimeKind.Utc).AddTicks(1121), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Modern React development patterns and best practices", 8, new TimeSpan(0, 0, 35, 0, 0), 734003200L, false, true, 156, null, new DateTime(2026, 1, 7, 20, 25, 26, 357, DateTimeKind.Utc).AddTicks(1115), 1080, 2, "React,JavaScript,Frontend,Best Practices", "https://example.com/images/react-best-practices-thumb.jpg", "React Best Practices 2024", null, null, "https://example.com/videos/react-best-practices.mp4", 2100 },
                    { new Guid("77777777-7777-7777-7777-777777777777"), true, new DateTime(2026, 1, 10, 20, 25, 26, 357, DateTimeKind.Utc).AddTicks(1140), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Understanding database design principles and normalization", 0, new TimeSpan(0, 0, 42, 0, 0), 419430400L, false, false, 0, null, null, 720, 0, "Database,SQL,Design,Normalization", "https://example.com/images/database-design-thumb.jpg", "Database Design Fundamentals", null, null, "https://example.com/videos/database-design.mp4", 0 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("88888888-8888-8888-8888-888888888888"), true, true, "https://example.com/audio/ai-software-dev.mp3", "https://example.com/images/ai-software-cover.jpg", new DateTime(2026, 1, 2, 20, 25, 26, 360, DateTimeKind.Utc).AddTicks(3712), null, new Guid("22222222-2222-2222-2222-222222222222"), null, null, "Exploring how artificial intelligence is transforming the way we write code", 23, new TimeSpan(0, 0, 45, 0, 0), 15, 43200000L, false, true, 67, 850, new DateTime(2026, 1, 4, 20, 25, 26, 359, DateTimeKind.Utc).AddTicks(6051), 2, new Guid("11111111-1111-1111-1111-111111111111"), 2, "AI,Software Development,Machine Learning,Future", "The Future of AI in Software Development", "Welcome to Tech Talk Weekly. Today we're discussing the future of AI in software development...", null, null },
                    { new Guid("99999999-9999-9999-9999-999999999999"), true, true, "https://example.com/audio/scalable-teams.mp3", "https://example.com/images/scalable-teams-cover.jpg", new DateTime(2026, 1, 4, 20, 25, 26, 360, DateTimeKind.Utc).AddTicks(3826), null, new Guid("44444444-4444-4444-4444-444444444444"), null, null, "Strategies for building and managing high-performing development teams", 45, new TimeSpan(0, 0, 38, 0, 0), 8, 36700000L, false, true, 94, 1200, new DateTime(2026, 1, 6, 20, 25, 26, 360, DateTimeKind.Utc).AddTicks(3812), 1, new Guid("33333333-3333-3333-3333-333333333333"), 2, "Team Management,Leadership,Scaling,Business", "Building Scalable Teams", "In today's episode of Business Insights, we explore strategies for building scalable teams...", null, null }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnswerHistories_AnswerId_Version",
                table: "AnswerHistories",
                columns: new[] { "AnswerId", "Version" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AnswerHistories_EditedByUserId",
                table: "AnswerHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_IsRTLPreferred",
                table: "AspNetUsers",
                column: "IsRTLPreferred");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QAUserFeedback_UserId",
                table: "QAUserFeedback",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranslationAudits_CreatedAt",
                table: "TranslationAudits",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationAudits_Culture_Feature",
                table: "TranslationAudits",
                columns: new[] { "Culture", "Feature" });

            migrationBuilder.CreateIndex(
                name: "IX_TranslationAudits_TranslationKey",
                table: "TranslationAudits",
                column: "TranslationKey");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationAudits_UpdatedBy",
                table: "TranslationAudits",
                column: "UpdatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationCompleteness_CompletionPercentage",
                table: "TranslationCompleteness",
                column: "CompletionPercentage");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationCompleteness_Culture",
                table: "TranslationCompleteness",
                column: "Culture");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationCompleteness_Culture_Feature_Unique",
                table: "TranslationCompleteness",
                columns: new[] { "Culture", "Feature" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TranslationCompleteness_Feature",
                table: "TranslationCompleteness",
                column: "Feature");

            migrationBuilder.CreateIndex(
                name: "IX_TranslationCompleteness_LastUpdated",
                table: "TranslationCompleteness",
                column: "LastUpdated");
